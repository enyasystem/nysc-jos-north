...
export default function Home() {
  ...
  {/* Dev Section: developer bios and contact links */}
      <section className="py-20 bg-gradient-to-b from-white/6 to-transparent">
                ...
                <CardContent className="bg-transparent p-0 flex flex-col h-full justify-between">
                  ...
                  <div className="mt-3 flex items-center justify-between gap-3">
                    <a
                      ...
                      className="inline-flex items-center px-3 py-2 rounded-md bg-white/6 text-white text-sm hover:bg-white/10 shadow-sm transition-colors"
                    >
                      <svg className="w-4 h-4 mr-2" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
                        <path fillRule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.58.82-2.14-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82A7.6 7.6 0 018 4.58c.68.003 1.36.092 2 .27 1.53-1.03 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.14 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.19 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z" />
                      </svg>
                      GitHub
                    </a>
                    <a
                      href={`mailto:${dev.name.toLowerCase()}@example.com`}
                      className="inline-flex items-center px-3 py-2 rounded-md border border-white/10 text-sm text-white/90 hover:border-white/20 hover:bg-white/5 transition-colors"
                    >
                      <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        {/* View all devs button (reduced top spacing) */}
      <section className="py-2">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Link href="/developers">
            <Button size="lg" className="px-5 py-2 rounded-full bg-white/6 text-white hover:bg-white/10 shadow">View all developers</Button>
          </Link>
        </div>
      </section>
      </section>
      ...
      <section className="py-16 bg-background">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Link href="/resources">
            <Button size="md" className="px-5 py-2 rounded-full bg-white/6 text-white hover:bg-white/10 shadow">View more resources</Button>
          </Link>
        </div>
      </section>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8">
            <Link href="/excos">
              <Button variant="green" className="text-muted-foreground hover:text-foreground hover:bg-white/10">View full committee</Button>
            </Link>
          </div>
        </div>
      </section>
