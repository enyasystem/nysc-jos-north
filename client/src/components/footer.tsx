        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold">NYSC Jos North</h3>
                <p className="text-white/80 text-sm">Official Biodata Platform</p>
              </div>
            </div>
            <p className="text-white/80 mb-6 max-w-md">
              Empowering corps members through comprehensive platform management and 
              community engagement in Jos North Local Government Area.
            </p>
